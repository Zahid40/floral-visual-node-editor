...
const Icon: React.FC<{ type: NodeType }> = ({ type }) => {
    ...
    switch (type) {
        ...
        case NodeType.OUTPUT:
             return <svg xmlns="http://www.w3.org/2000/svg" className={baseClasses} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><path d="M12 22a10 10 0 1 1 0-20 10 10 0 0 1 0 20z" /><path d="M22 12h-4" /><path d="M6 12H2" /><path d="M12 6V2" /><path d="M12 22v-4" /></svg>;
        default:
            return null;
    }
};
...
export const Sidebar: React.FC = () => {
    return (
        <aside className="w-64 bg-neutral-950/30 border-r border-neutral-800 p-4 space-y-4 z-10 backdrop-blur-sm">
            ...
            <DraggableNode type={NodeType.OUTPUT} label="Output" icon={<Icon type={NodeType.OUTPUT}/>} />
        </aside>
    );
};
