...
export const Sidebar: React.FC = () => {
    return (
        <aside className="w-64 bg-black/50 border-r border-[#3A3A3A]/50 p-4 space-y-4 z-10">
            ...
            <DraggableNode type={NodeType.IMAGE} label="Image Input" icon={<Icon type={NodeType.IMAGE}/>} />
            <DraggableNode type={NodeType.TEXT} label="Text Prompt" icon={<Icon type={NodeType.TEXT}/>} />
            <DraggableNode type={NodeType.MERGE} label="Merge / Blend" icon={<Icon type={NodeType.MERGE}/>} />
