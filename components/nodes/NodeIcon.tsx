...
export const NodeIcon: React.FC<{ type: NodeType, className?: string }> = ({ type, className }) => {
    ...
    switch (type) {
        ...
        // FIX: Added case for NodeType.OUTPUT to render an icon for output nodes.
        case NodeType.OUTPUT:
            return <svg xmlns="http://www.w3.org/2000/svg" className={baseClasses} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"></circle><circle cx="12" cy="12" r="6"></circle><circle cx="12" cy="12" r="2"></circle></svg>;
        default:
            return null;
    }
};